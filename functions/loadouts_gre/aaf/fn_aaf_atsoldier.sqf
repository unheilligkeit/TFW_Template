...
// Rücksäcke
_rucksackearray = selectRandom ["B_Kitbag_sgg","B_Kitbag_rgr"];
...
_sekwaffenarray = selectRandom [["launch_B_Titan_short_F","Titan_AT"],["launch_O_Titan_short_F","Titan_AT"],["launch_I_Titan_short_F","Titan_AT"]];
