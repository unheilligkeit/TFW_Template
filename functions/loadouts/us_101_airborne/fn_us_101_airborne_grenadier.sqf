...
// Westen
_westenarray = selectRandom ["fow_v_us_ab_garand","fow_v_us_ab_carbine","fow_v_us_ab_garand_bandoleer","fow_v_us_ab_grenade"];
...
for "_i" from 1 to 10 do {_unit addItemToVest "fow_1Rnd_m9a1";};
...
_waffenarray = selectRandom [["fow_w_m1_garand","fow_8Rnd_762x63"],["fow_w_m1_garand_2","fow_8Rnd_762x63"],["fow_w_m1_garand_l","fow_8Rnd_762x63"]];
