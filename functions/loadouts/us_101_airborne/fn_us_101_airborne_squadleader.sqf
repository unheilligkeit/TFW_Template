...
// Uniform
_uniformarray = selectRandom ["fow_u_us_m42_ab_01_101_sergeant","fow_u_us_m42_ab_01_101_flag_sergeant"];
_unit forceAddUniform _uniformarray ;

// Westen
_westenarray = selectRandom ["fow_v_us_ab_thompson_nco","fow_v_us_ab_thompson"];
...
// Helme
_helmearray = selectRandom ["fow_h_us_m1_nco","fow_h_us_m1_nco_closed","fow_h_us_m1_nco_folded"];
