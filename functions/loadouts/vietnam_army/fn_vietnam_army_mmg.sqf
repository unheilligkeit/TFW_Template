...
for "_i" from 1 to 3 do {_unit addItemToBackpack "uns_m60mag_200";};
...
_waffenarray = selectRandom [["uns_m60support","uns_m60mag_200"]];
_waffe = _waffenarray select 0;
_munition = _waffenarray select 1;

_unit addWeapon _waffe;
for "_i" from 1 to 1 do {_unit addMagazine _munition;};
