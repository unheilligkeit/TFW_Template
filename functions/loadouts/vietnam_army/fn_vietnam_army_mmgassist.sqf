...
// Helme
_helmearray = selectRandom ["UNS_M1_2A","UNS_M1_5A","UNS_M1_6A","UNS_M1_7A","UNS_M1_8A"];
...
for "_i" from 1 to 5 do {_unit addItemToBackpack "uns_m60mag_200";};
...
_waffenarray = selectRandom [["uns_m16","uns_20Rnd_556x45_Stanag"],["uns_m16_dm","uns_20Rnd_556x45_Stanag"]];
